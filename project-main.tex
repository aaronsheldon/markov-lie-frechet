...
Computation of the Maximum Likelihood Estimator of the Generator of Continuous Time 
Homogeneous Markov Processes on Finite State Spaces from Stopped Random Variables}
...
% Harpoon vectors; does not subscript properly
%\newcommand{\tightoverset}[2]{\mathop{#2}\limits^{\vbox to -.5ex{\kern-0.8ex\hbox{$#1$}\vss}}}
%\renewcommand{\vec}{\tightoverset{\rightharpoonup}}
