...
The state transitions of the dual algebra matrices $C_{iin} + C_{jjn} - C_{ijn}$
are illustrated in figure \ref{fig:dualdoublestochastic}.
...
\begin{figure}
	...
	\end{tikzpicture}
	\caption[Dual algebra $C_{iin} + C_{jjn} - C_{ijn}$]{State transition circuit diagram of the dual algebra $C_{iin} + C_{jjn} - C_{ijn}$ to the canonical generators $C_{ijn}$ of $\mathfrak{st}(\hat{\mathbbm{1}}, \hat{\mathbbm{1}})$}
	\label{fig:dualdoublestochastic}
\end{figure} 
