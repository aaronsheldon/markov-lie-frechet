...
\end{longtable}
\begin{algorithm}[!ht]
	\caption[Linear perturbation of $\frac{\partial^2 e^X}{\partial x \partial y}$]{Numerical calculation of the linear perturbation of $\frac{\partial^2 e^X}{\partial x \partial y}$.}
	\label{alg:linear}
	\begin{algorithmic}[1]
